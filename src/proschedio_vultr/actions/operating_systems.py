...
from ..urls import URL_OS # Updated import

class OperatingSystems:
    @staticmethod # Add staticmethod decorator
    async def list_os_images(per_page: int | None, cursor: str | None) -> Result[SuccessResponse, ErrorResponse]: # Removed self, updated types and return type
        """
