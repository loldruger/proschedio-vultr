...
async def list_block_storage(per_page: int | None, cursor: str | None) -> Result[SuccessResponse, ErrorResponse]:
    """
...
async def create_block_storage(region: str, size_gb: int, label: str | None, block_type: str | None) -> Result[SuccessResponse, ErrorResponse]:
    """
...
async def get_block_storage_by_id(block_id: str) -> Result[SuccessResponse, ErrorResponse]:
    """
...
async def update_block_storage_by_id(block_id: str, label: str | None, size_gb: int | None) -> Result[SuccessResponse, ErrorResponse]:
    """
...
async def delete_block_storage_by_id(block_id: str) -> Result[SuccessResponse, ErrorResponse]:
    """
...
async def attach_block_storage(block_id: str, instance_id: str, live: bool | None) -> Result[SuccessResponse, ErrorResponse]:
    """
...
async def detach_block_storage(block_id: str, live: bool | None) -> Result[SuccessResponse, ErrorResponse]:
    """
